...
public class Bot extends TelegramLongPollingBot {
    ...
    private String[] messagesForUserOfTheDay = {
            "\uD83C\uDF89 Сегодня топчик дня - ",
            "ВНИМАНИЕ \uD83D\uDD25",
            "Ищем топчика в этом чате",
            "Гадаем кофейной гуще Павла Цоя \uD83D\uDCCA",
            "Анализируем лунный гороскоп Олеси \uD83C\uDF16",
            "Спасаем из командировок Красногорова \uD83D\uDCAB",
            "У каждого своё мнение, а топчик дня \uD83C\uDFAF"
    };
    private String[] messagesForLoserOfTheDay = {
            ...
            "4 - спутник запущен \uD83D\uDE80",
            "3 - сводки Морозовой Кати проверены \uD83D\uDE93",
            "2 - друзья Цоя опрошены \uD83D\uDE45",
            "1 - ЕКФ СИЛА, лох дня \uD83D\uDE40"
